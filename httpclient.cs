...
var response = client.PostAsync("https://api.oracle.com/urlpath", new StringContent(JsonConvert.SerializeObject(data, hello), Encoding.UTF8, "application/json")).Result;
